...
export const OfficeLocationCard = lazy(() => import("./OfficeLocationCard"));
export const OfficeLocator = lazy(() => import("./OfficeLocator"));
...
export const SocialMediaShare = lazy(() => import("./SocialMediaShare"));
